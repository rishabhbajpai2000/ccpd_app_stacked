...
import 'package:ccpd_app_stacked/ui/views/login/login_viewmodel.dart';
...
final Map<String, String? Function(String?)?> _LoginViewTextValidations = {
  EmailValueKey: LoginValidators.emailValidator,
  PasswordValueKey: LoginValidators.passwordValidator,
};
